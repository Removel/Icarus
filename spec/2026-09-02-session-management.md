...
- `apps/agent/docs/spec/2026-09-02-session-management/arch.md`；
- `apps/gateway/docs/spec/2026-09-02-session-management-rpc/arch.md`；
- `apps/tui/docs/spec/2026-09-02-tui-session-management/arch.md`。

实施计划：

- `apps/agent/docs/spec/2026-09-02-session-management/plan.md`；
- `apps/gateway/docs/spec/2026-09-02-session-management-rpc/plan.md`；
- `apps/tui/docs/spec/2026-09-02-tui-session-management/plan.md`。
