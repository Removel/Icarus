...
> 第一阶段终端框架设计和实施记录分别见
> `apps/tui/docs/spec/2026-08-19-tui-terminal-framework/arch.md` 与
> `apps/tui/docs/spec/2026-08-19-tui-terminal-framework/plan.md`。当前 Textual TUI 设计和
> 计划见 `apps/tui/docs/spec/2026-08-19-tui-persistent-input-queue/arch.md` 与
> `apps/tui/docs/spec/2026-08-19-tui-persistent-input-queue/plan.md`。
