...
基于 `apps/tui/docs/spec/2026-08-19-tui-terminal-framework/arch.md`，把当前标准库串行 REPL
...
旧的 `apps/tui/docs/spec/2026-08-19-tui-terminal-framework/plan-legacy-repl.md` 描述已经落地的标准库 MVP。
...
- 把 TODO 文档中的设计链接更新为对应的 `apps/tui/docs/spec/YYYY-MM-DD-<feature>/arch.md`，
  不再指向根 `spec/`。
