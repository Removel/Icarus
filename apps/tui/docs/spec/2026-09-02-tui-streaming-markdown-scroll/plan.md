...
依据 `apps/tui/docs/spec/2026-09-02-tui-streaming-markdown-scroll/arch.md`，完成两个已经定位的问题：
...
- `apps/tui/README.md`
- `apps/tui/docs/spec/2026-08-20-tui-first-interaction-experience/arch.md`
- `apps/tui/docs/spec/2026-09-02-tui-streaming-markdown-scroll/arch.md`
- `apps/tui/docs/spec/2026-09-02-tui-streaming-markdown-scroll/plan.md`
