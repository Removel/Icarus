...
- `apps/tui/docs/spec/2026-08-20-tui-first-interaction-experience/arch.md` 的 anchor 跟随策略；
- `apps/tui/docs/spec/2026-08-19-tui-persistent-input-queue/arch.md` 的输出期间可编辑要求；
- `apps/tui/docs/spec/2026-08-19-tui-persistent-input-queue/plan.md` 中使用 Textual `Markdown` / `MarkdownStream` 的既定方向。
