...
DEFAULT_EMBEDDER_PROVIDER = os.environ.get("MEM0_DEFAULT_EMBEDDER_PROVIDER", "fastembed")
DEFAULT_EMBEDDER_MODEL = os.environ.get(
    "MEM0_DEFAULT_EMBEDDER_MODEL",
    "sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2",
)
DEFAULT_EMBEDDING_DIMS = int(os.environ.get("MEM0_DEFAULT_EMBEDDING_DIMS", "384"))
...
DEFAULT_CONFIG = {
    ...
    "embedder": {
        ...
        "config": {"model": DEFAULT_EMBEDDER_MODEL, "embedding_dims": DEFAULT_EMBEDDING_DIMS},
    },
