...
- EventBus 与 Blackboard：`apps/agent/docs/spec/2026-08-15-plugin-eventbus-blackboard/arch.md`；
- 当前 Plugin 事件流：`apps/agent/docs/spec/2026-08-18-plugin-event-flow-current-state/arch.md`；
- Agent 运行中介入：`apps/agent/docs/spec/2026-08-22-agent-run-intervention/arch.md`；
- Agent 基础能力：`apps/agent/docs/spec/2026-08-27-agent-core-capability-completion/arch.md`；
- MCP Client：`apps/agent/docs/spec/2026-09-05-mcp-client-plugin/arch.md`。
...
完整的通用 Region、Conversation 和 Active Context 定义见 `apps/agent/docs/spec/2026-08-15-plugin-eventbus-blackboard/arch.md`。本节只定义 MemoryPlugin 如何使用该通用能力。
...
Blackboard 的终态提交按 `apps/agent/docs/spec/2026-09-20-agent-run-history-steering/arch.md` 执行：成功时提交完整
...
具体文件修改顺序、测试命令拆分和提交边界在用户审阅本设计后另行写入同目录的 `plan.md`。
