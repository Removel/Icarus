...
实现 `apps/agent/docs/spec/2026-08-17-skill-plugin/arch.md` 的第一阶段：从全局和 Workspace 目录发现 Skill，使用 FastEmbed 动态检索 Top 3，维护会话累计注入列表，并通过 Blackboard 把 Skill 元信息加入实际 User Prompt 和跨轮历史。
