...
> `apps/agent/docs/spec/2026-08-17-skill-plugin/arch.md` 为准，后续修正计划单独维护。

## 目标

实现 `apps/agent/docs/spec/2026-08-17-skill-plugin/arch.md` 的第二阶段：在一轮主 Agent 对话成功结束后，根据本轮工具调用数量决定是否启动后台 Skill 维护 Agent，并以结构化计划安全地创建、更新、合并或删除 Workspace Skill。
