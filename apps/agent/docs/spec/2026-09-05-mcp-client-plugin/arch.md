...
- Agent 编排基础：`apps/agent/docs/spec/2026-08-15-agent-orchestration-foundation/arch.md`；
- Agent 基础能力：`apps/agent/docs/spec/2026-08-27-agent-core-capability-completion/arch.md`；
- 文件持久化：`apps/agent/docs/spec/2026-08-16-file-persistence-observability/arch.md`。
