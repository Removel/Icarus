...
基于 `apps/agent/docs/spec/2026-09-20-agent-run-history-steering/arch.md`，在不新增 Turn、不修改 Gateway/TUI
...
- `apps/agent/docs/spec/2026-08-22-agent-run-intervention/arch.md`
...
- `apps/agent/docs/spec/2026-09-15-memory-knowledge-plugin/plan.md`
