...
> Context 的分离，以 `apps/agent/docs/spec/2026-09-20-agent-run-history-steering/arch.md` 为准。本文其余 TaskChannel、取消传播和
> 安全检查点设计继续有效。
...
实现计划与本文放在同一个 feature spec 目录，并在本文评审通过后单独编写为 `plan.md`。
