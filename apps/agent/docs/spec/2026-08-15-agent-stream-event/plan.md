...
> `apps/agent/docs/spec/2026-08-27-agent-core-capability-completion/arch.md`。

## 目标

基于 `apps/agent/docs/spec/2026-08-15-agent-stream-event/arch.md`，为当前无状态 ReActAgent 增加：
...
- `apps/agent/docs/spec/2026-08-15-plugin-eventbus-blackboard/arch.md`
...
- `apps/agent/docs/spec/2026-08-15-agent-orchestration-foundation/arch.md`
- `apps/agent/docs/spec/2026-08-15-agent-orchestration-foundation/plan.md`
