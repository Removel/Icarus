...
> `apps/agent/docs/spec/2026-08-29-device-agent-runtime-session/arch.md`；Session/Conversation 数据存储见
> `apps/agent/docs/spec/2026-09-04-session-store/arch.md`。本文不再作为当前数据流事实源。

> 本文记录迁移前的单 Session、TUI 进程内直连 `AgentRuntimeService` 历史架构。设备级多 Session
> 目标架构见 `apps/agent/docs/spec/2026-08-29-device-agent-runtime-session/arch.md`；Gateway 网络边界见
> `apps/gateway/docs/spec/2026-08-29-agent-gateway-positioning/arch.md`。目标架构落地后，本文中的直连关系将
...
`apps/tui/docs/spec/2026-08-19-tui-persistent-input-queue/arch.md` 为准。本文只保留
