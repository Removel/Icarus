...
基于 `apps/agent/docs/spec/2026-09-04-session-store/arch.md`，将当前由 Session 目录和
...
- `apps/agent/docs/spec/2026-09-04-session-store/plan.md`
- `docs/todo/agent-core.md`
- `docs/todo/development-roadmap.md`

### 开发内容

1. 实施完成后移除 `apps/agent/docs/spec/2026-09-04-session-store/arch.md` 顶部“尚未实现”标记，并将当前事实更新为 SessionStore。
