...
基于 `apps/agent/docs/spec/2026-08-15-agent-orchestration-foundation/arch.md`，完成 Agent 编排层第一阶段基础能力：
...
- `apps/agent/docs/spec/2026-08-13-model-provider-layer/arch.md`
...
- `apps/agent/docs/spec/2026-08-15-agent-stream-event/plan.md`
