...
- 当前已由 Harness 提供默认 256 个模型 Step 的硬上限；不增加启发式循环检测；
...
- `apps/agent/docs/spec/2026-08-16-file-persistence-observability/arch.md`
...
`apps/agent/docs/spec/2026-08-15-agent-stream-event/arch.md` 为准。
