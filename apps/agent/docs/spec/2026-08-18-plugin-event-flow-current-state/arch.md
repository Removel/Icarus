...
长期架构原则见 `apps/agent/docs/spec/2026-08-15-plugin-eventbus-blackboard/arch.md`，Manifest 与生命周期契约见
`apps/agent/docs/spec/2026-08-23-plugin-runtime-manifest-lifecycle/arch.md`，SkillPlugin 细节见 `apps/agent/docs/spec/2026-08-17-skill-plugin/arch.md`。
...
required Region。完整设计见 `apps/agent/docs/spec/2026-08-15-plugin-eventbus-blackboard/arch.md`，Memory Region 接入见
`apps/agent/docs/spec/2026-09-15-memory-knowledge-plugin/arch.md`。
